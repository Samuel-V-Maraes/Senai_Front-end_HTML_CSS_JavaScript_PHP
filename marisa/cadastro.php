        ...
        <div class="cadastro_box">
            ...
            <div class="cadastro_box1">
                ...
                <form action="" method="" class="form1">
                    ...
                    <div class="box_form">
                        ...
                        <div class="box_form_celular">
                            <b>Celular *</b>
                            <input type="text" name="celular" placeholder="00000 - 0000" class="inp_cad5" id="celular" onkeyup="mascaraCel(this.id);" />
                        </div>
                        ...
                        <div class="box_form_tel">
                            <b>Telefone *</b>
                            <input type="text" name="tel" placeholder="0000 - 0000" class="inp_cad5" id="tel" onkeyup="mascaraTel(this.id);"/>
                        </div>
                    </div>
                ...
                <form action="" method="" class="form1_1">
                    ...
                    <div class="box_form">
                        <b>CNPJ *</b>
                        <input type="text" name="cnpj" placeholder="" class="inp_cad1" id="cnpj" />
                    </div>
                    ...
                    <div class="box_form">
                        <div class="box_form_ddd1">
                            <b>DDD *</b>
                            <input type="text" name="ddd1_1" placeholder="(00)" class="inp_cad4" id="ddd1_1" />
                        </div>
                        <div class="box_form_celular">
                            <b>Celular *</b>
                            <input type="text" name="celular1" placeholder="0000 - 0000" class="inp_cad5" id="celular1" />
                        </div>
                        <div class="box_form_ddd2">
                            <b>DDD *</b>
                            <input type="text" name="ddd2_1" placeholder="(00)" class="inp_cad4" id="ddd2_1"/>
                        </div>
                        <div class="box_form_tel">
                            <b>Telefone *</b>
                            <input type="text" name="tel1" placeholder="0000 - 0000" class="inp_cad5" id="tel1"/>
                        </div>
                    </div>
            ...
            <div class="cadastro_box2">
                <form action="" method="" class="form2">
                    ...
                    <div class="box_form">
                        <b>Senha*</b>
                        <input type="text" name="senha" placeholder="Insira a senha" class="inp_cad1" id="senha" />
                    ...
                    <div class="box_form">
                        <b>Confirmar Senha*</b>
                        <input type="text" name="senha2" placeholder="Insira a senha novamente" class="inp_cad1" id="senha1" />
                        <div class="box_bt_mostrar">
                            <img src="images/eye-slash.png" alt="Mostra Senha" class="bt_mostra_senha" />
                        </div>
                    </div>
